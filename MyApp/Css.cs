...
// Tailwind classes used in C#
public static class Css
{
    public const string H1 = "text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl";
    public const string H2 = "text-4xl md:text-6xl font-bold tracking-tighter leading-tight md:pr-8 whitespace-nowrap text-center pt-8";
...
public static class CssHtmlExtensions
{
    ...
    public static IHtmlContent SrcRazorPage(this IHtmlHelper html, string path, string? size = null, string? cls = null) =>
        html.SrcLink($"/MyApp/Pages/{path}", size, cls);
