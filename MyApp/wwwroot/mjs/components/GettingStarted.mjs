    ...
    <div class="flex flex-col w-96">
      ...
      <div class="mt-8 text-center">
        <div class="flex justify-center">
          <a class="bg-purple-500 text-purple-50 rounded px-2 py-0.5 mx-1" href="/Blog/rider">rider</a>
          <a class="bg-purple-500 text-purple-50 rounded px-2 py-0.5 mx-1" href="/Blog/vs">visualstudio</a>
        </div>
      </div>        
    </div>`,
    components: {
